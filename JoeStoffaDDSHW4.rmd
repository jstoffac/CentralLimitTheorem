...
for (i in 1:100) { 
  randomSample <- sample(normal, 10, replace = FALSE)
...
meansOfRandomSamples = 1
for (i in 1:100) { 
  randomSample <- sample(exponential, 10, replace = FALSE)
  meansOfRandomSamples[i] <- mean(randomSample) 
  }
hist(meansOfRandomSamples)
```
...
meansOfRandomSamples = 1
for (i in 1:100) { 
  randomSample <- sample(normal, 100, replace = FALSE)
  meansOfRandomSamples[i] <- mean(randomSample) 
  }
hist(meansOfRandomSamples)
```
...
meansOfRandomSamples = 1
for (i in 1:100) { 
  randomSample <- sample(exponential, 100, replace = FALSE)
  meansOfRandomSamples[i] <- mean(randomSample) 
  }
hist(meansOfRandomSamples)
```
